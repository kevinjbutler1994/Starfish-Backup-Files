...
from .views import Home, CatList, CatDetail, ToyList, ToyDetail, AddToyToCat, RemoveToyFromCat, FeedingListCreate, FeedingDetail, CreateUserView, LoginView, VerifyUserView# additional imports
