...
SECRET_KEY = 'django-insecure-3_h_lju_q+tgoe+1*lm3zg@fz1v_+q+6w!0t4bq=ibo0bcqize'
...
DATABASES = {
    'default': {
        ...
        # 'USER': 'finch_admin', <-- (optional) postgres user name, if you have to sign into an account to open psql, you will want to add that user name here.
